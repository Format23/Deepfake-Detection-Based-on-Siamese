...
from netall.xcefenlei import *
from netall.Meso4 import *
from createfenlei import *
...
def main():
     ...
     for epoch in range(epoches):
         ...
         for i in range(max_iters):
             ...
             optimizer.zero_grad()
             outputs = model(image_f)
             loss = criterion(outputs, label)#label是target，outputs是input
             loss.backward()
             optimizer.step()
...
if __name__ == '__main__':
    ...
    parse.add_argument('--lr', '--learning-rate', default=0.001, type=float, metavar='LR',help='initial learning rate')#0.0001
